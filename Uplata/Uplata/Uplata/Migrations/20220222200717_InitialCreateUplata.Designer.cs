...
namespace Uplata.Migrations
{
    ...
    [Migration("20220222200717_InitialCreateUplata")]
            ...
            modelBuilder.Entity("Uplata.Entities.KursEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 22, 21, 7, 15, 908, DateTimeKind.Local).AddTicks(592),
                            Valuta = "EUR",
                            VrednostKursa = 117.8
                        },
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 22, 21, 7, 15, 921, DateTimeKind.Local).AddTicks(3227),
                            Valuta = "GBT",
                            VrednostKursa = 150.5
                        });
                });
            ...
            modelBuilder.Entity("Uplata.Entities.UplataEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 22, 21, 7, 15, 921, DateTimeKind.Local).AddTicks(3860),
                            Iznos = "200",
                            KursID = new Guid("411c4082-cc5e-4f5f-8946-4086ebca08d0"),
                        ...
                        new
                        {
                            ...
                            BrojRacuna = "155-228523852256500-25",
                            Datum = new DateTime(2022, 2, 22, 21, 7, 15, 921, DateTimeKind.Local).AddTicks(6286),
                            Iznos = "100",
                            KursID = new Guid("b06a4284-44e2-46af-8d74-b79c8b0c6017"),
                        ...
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 22, 21, 7, 15, 921, DateTimeKind.Local).AddTicks(6388),
                            Iznos = "50",
                            KursID = new Guid("411c4082-cc5e-4f5f-8946-4086ebca08d0"),
