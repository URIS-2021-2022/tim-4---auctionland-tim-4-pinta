...
namespace Uplata.Migrations
{
    ...
    [Migration("20220219145001_Create")]
            ...
            modelBuilder.Entity("Uplata.Entities.UplataModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 19, 15, 49, 59, 847, DateTimeKind.Local).AddTicks(7546),
                            Iznos = "150000",
                        ...
                        new
                        {
                            ...
                            Datum = new DateTime(2022, 2, 19, 15, 49, 59, 855, DateTimeKind.Local).AddTicks(5588),
                            Iznos = "200000",
                            JavnoNadmetanjeID = new Guid("6a411c23-a192-48f7-8dbd-67596c3974c0"),
                            KupacID = new Guid("6a411c23-a195-48f7-8dbd-67596c3974c0"),
