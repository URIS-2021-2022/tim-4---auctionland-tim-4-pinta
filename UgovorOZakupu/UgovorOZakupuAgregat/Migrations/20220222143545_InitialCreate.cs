...
namespace UgovorOZakupuAgregat.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Ugovori",
                columns: new[] { "UgovorId", "DatumPotpisa", "DatumZavodjenja", "DokumentId", "JavnoNadmetanjeId", "KupacId", "LicnostId", "MestoPotpisivanja", "RokZaVracanjeZemljista", "TipId", "ZavodniBroj" },
                values: new object[] { new Guid("407c6e21-0765-44e9-a34b-b2c387814e55"), new DateTime(2021, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("d1209104-7358-4c22-9f4f-415203563a25"), new Guid("3bd80c2a-c790-402f-b214-e3ebbc29d89f"), new Guid("1a411c13-a195-48f7-8dbd-67596c3974c0"), new Guid("e91b29cc-79a5-4de8-8030-77df6e514def"), "Novi Sad", new DateTime(2021, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e1f134e5-25f9-4b00-8b96-a809d11cd33b"), "11a" });
